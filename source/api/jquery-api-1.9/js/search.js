...
},
{
    ...
    "url": "../deferred.catch/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/deferred.catch/*/,
    "desc": "当Deferred对象被拒绝(reject)时，调用添加的处理程序。",
    "slug": "deferred.catch"
},
{
    "title": "deferred.done()",
...
},
{
    ...
    "url": "../jQuery.fn.extend/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/jQuery.fn.extend/*/,
    "desc": "一个对象的内容合并到jQuery的原型，以提供新的jQuery实例方法。",
    "slug": "jQuery.fn.extend"
},
{
...
},
{
    ...
    "url": "../jQuery.readyException/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/jQuery.readyException/*/,
...
{
    "title": ".trigger()",
    "url": "../trigger/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/trigger/*/,
    "desc": "根据绑定到匹配元素的给定的事件类型执行所有的处理程序和行为。",
    "slug": "trigger"
},
{
    "title": ".triggerHandler()",
    "url": "../triggerHandler/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/triggerHandler/*/,
    "desc": "为一个事件执行附加到元素的所有处理程序。",
    "slug": "triggerHandler"
},
{
    "title": ".unbind()",
    "url": "../unbind/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/unbind/*/,
    "desc": "从元素上删除一个以前附加事件处理程序。",
    "slug": "unbind"
},
{
    "title": ".undelegate()",
    "url": "../undelegate/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/undelegate/*/,
    "desc": "删除当前选择器匹配的所有元素的事件处理程序，根据一组特定根元素的集合。",
    "slug": "undelegate"
},
{
    "title": ".unload()",
    "url": "../unload/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/unload/*/,
    "desc": "为“unload”JavaScript事件绑定一个事件处理程序。",
    "slug": "unload"
},
{
    "title": ".unwrap()",
    "url": "../unwrap/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/unwrap/*/,
    "desc": "将匹配元素集合的父级元素删除，保留自身（和兄弟元素，如果存在）在原来的位置。",
    "slug": "unwrap"
},
{
    "title": ".val()",
    "url": "../val/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/val/*/,
    "desc": "获取匹配的元素集合中第一个元素的当前值或设置匹配的元素集合中每个元素的值。",
    "slug": "val"
},
{
    "title": ":visible Selector",
    "url": "../visible-selector/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/visible-selector/*/,
    "desc": "选择所有可见的元素。",
    "slug": ":visible Selector"
},
{
    "title": ".width()",
    "url": "../width/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/width/*/,
    "desc": "为匹配的元素集合中获取第一个元素的当前计算宽度值或给每个匹配的元素设置宽度。",
    "slug": "width"
},
{
    "title": ".wrap()",
    "url": "../wrap/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/wrap/*/,
    "desc": " 在每个匹配的元素外层包上一个html元素。",
    "slug": "wrap"
},
{
    "title": ".wrapAll()",
    "url": "../wrapAll/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/wrapAll/*/,
    "desc": "在所有匹配元素外面包一层HTML结构。",
    "slug": "wrapAll"
},
{
    "title": ".wrapInner()",
    "url": "../wrapInner/index.htm"/*tpa=http://www.css88.com/jqapi-1.9/wrapInner/*/,
        ...
        window.addEventListener('load', function (event) {
          setTimeout(function () {
             if(browser.versions.mobile||browser.versions.android||browser.versions.ios){
              ...
              if(browser.versions.webKit){cryFace();}
          }, 4000);
        });
      function cryFace(){

          if(jQuery(".jquery-api-top img").is(":hidden")||jQuery("#sup-post-a img").is(":hidden")){
              jQuery("body").append(['<div class="cry-face-dia" style="width: 100%;  height: 100%;  position: fixed;background-color: rgba(51, 51, 51, 0.3);     top: 0;" id="cry-face-dia">',
              '    <div class="cry-face-con" style="height: 580px;  width: 646px;  position: absolute;  top: 50%;  margin-top: -310px;  left: 50%;  margin-left: -343px;  padding: 20px;  border-radius: 5px;  background-color: #E5E5E5;"><img src="../../img/donotblock.png"/*tpa=http://www.css88.com/img/donotblock.png*/ height="580" width="646" alt="本站依靠外链和广告维持，请勿屏蔽，万分感谢！">',
              '        <div class="cry-face-con-close" style="position: absolute;  top: 10px;  right: 10px;">',
              '            <a href="javascript:void 0;" title="关闭" id="cry-face-con-close"><img',
              '                src="../../img/donotblock-close.png"/*tpa=http://www.css88.com/img/donotblock-close.png*/ alt=""/></a></div>',
              '    </div>',
              '</div>'].join(""));
          }
          jQuery("#cry-face-con-close").click(function (e) {
              jQuery("#cry-face-dia").hide();
          });
